...
export const settingsType = defineType({
  ...
  fields: [
          ...
          of: [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  title: "Link",
                  description:
                    "Ścieżka URL (np. /o-nas, /galeria) lub pełny URL",
    ...
    defineField({
      name: "phones",
      type: "array",
      title: "Telefony kontaktowe",
      description: "Numery telefonów wyświetlane w stopce",
      of: [{ type: "string" }],
      group: "footer",
    }),
    defineField({
      ...
      type: "array",
      title: "Adresy email",
      description: "Adresy email wyświetlane w stopce",
      of: [{ type: "string" }],
      group: "footer",
    }),
    defineField({
